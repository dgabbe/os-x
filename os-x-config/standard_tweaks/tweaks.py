...
tweaks = [
    ...
    {'group': 'sudo',
     ...
     'get': 'sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.captive.control Active -boolean false',
     'os_v_min': '10.09', 'os_v_max': None
     },
    {'group': 'general',
    ...
    {'group': 'TBD', 'description': 'Expand Print menu by default',
    ...
    {'group': 'TBD',
     'description': 'Disable the animation when you sending and replying an e-mail',
